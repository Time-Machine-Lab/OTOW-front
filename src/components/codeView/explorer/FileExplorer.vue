...
export default {
  ...
  computed: {
    ...
    getChildren() {
      return (root) => this.$store.getters['Editor/getChildren'](root);
    },
    getDraggingId() {
      return this.$store.getters['Editor/getDraggingId'];
    },
    children() {
      if (this.getFiles) {
  ...
  methods: {
    ...
    setDraggingId(payload) {
      this.$store.commit('Editor/SET_DRAGGING_ID', payload);
    },

    createFile(payload) {
      return this.$store.dispatch('Files/createFile', payload);
    },

    createDirectory(payload) {
      return this.$store.dispatch('Files/createDirectory', payload);
    },

    moveFile(payload) {
      return this.$store.dispatch('Files/moveFile', payload);
    },

    setShowCreateFileModal(payload) {
      return this.$store.dispatch('UI/setShowCreateFileModal', payload);
    },
    createNewFile() {
