...
<script>
import Logo from "@/components/codeView/logo/Logo.vue";
import {
  FileTextIcon,
  SearchIcon,
  TrashIcon,
...
export default {
      ...
      bottomMenu: [
        {
          ...
          name: "Settings",
          click: () => {
            this.$router.push("/codeView/settings");
          },
        },
      ],
    };
  ...
  computed: {
    ...
    getPanels() {
      return this.$store.getters['UI/getPanels'];
    },
  },
  methods: {
    setActivePanelId(payload) {
      return this.$store.dispatch('UI/setActivePanelId', payload);
    },
  }
};
</script>
