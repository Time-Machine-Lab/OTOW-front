...
const marketCards = reactive<projectData[]>([
  {id:'0', name: 'Product 1', introduce: 'introduce for product 1', price: 10, cover: '@/assets/img/projectCover.jpg', codeLanguage: "java1",viewNums: 10, downloadNums: 0, nickname:"dct"},
  {id:'1', name: 'Product 2', introduce: 'introduce for product 1', price: 10, cover: '@/assets/img/projectCover.jpg', codeLanguage: "java1",viewNums: 10, downloadNums: 0, nickname:"dct"},
  {id:'2', name: 'Product 3', introduce: 'introduce for product 1', price: 10, cover: '@/assets/img/projectCover.jpg', codeLanguage: "java1",viewNums: 10, downloadNums: 0, nickname:"dct"},
  {id:'3', name: 'Product 3', introduce: 'introduce for product 1', price: 10, cover: '@/assets/img/projectCover.jpg', codeLanguage: "java1",viewNums: 10, downloadNums: 0, nickname:"dct"},
  {id:'4', name: 'Product 3', introduce: 'introduce for product 1', price: 10, cover: '@/assets/img/projectCover.jpg', codeLanguage: "java1",viewNums: 10, downloadNums: 0, nickname:"dct"},
  {id:'5', name: 'Product 3', introduce: 'introduce for product 1', price: 10, cover: '@/assets/img/projectCover.jpg', codeLanguage: "java1",viewNums: 10, downloadNums: 0, nickname:"dct"},
]);
</script>
